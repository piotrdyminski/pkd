...
export default function PriestsPage(props: InferGetStaticPropsType<typeof getStaticProps>) {
  const title = 'Duszpasterze';
...
export const getStaticProps: GetStaticProps<{
  ...
  props: { singlePageContent: await fetchAPIOrDefault<StrapiApiSingleResponse<SinglePageModel>>('/priest', {}) },
});
