...
export default function BaptismPage(props: InferGetStaticPropsType<typeof getStaticProps>) {
  const title = 'Sakrament Chrztu';
...
export const getStaticProps: GetStaticProps<{
  ...
  props: { singlePageContent: await fetchAPIOrDefault<StrapiApiSingleResponse<SinglePageModel>>('/baptism', {}) },
});
