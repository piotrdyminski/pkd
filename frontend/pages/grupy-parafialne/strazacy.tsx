...
export default function FirefightersPage(props: InferGetStaticPropsType<typeof getStaticProps>) {
  const title = 'Strażacy';
...
export const getStaticProps: GetStaticProps<{
  ...
  props: { singlePageContent: await fetchAPIOrDefault<StrapiApiSingleResponse<RichTextModel>>('/firefighter', {}) },
});
